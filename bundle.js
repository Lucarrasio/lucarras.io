        ...
        return p(p.s = 0)
            ...
            function e(b) {
                switch (b) {
                    ...
                    case 35:
                        return "#ffd300";
                    case 36:
                        return 150 > Date.now() % 300 ? l.guiblack : l.white;
                    case 37:
            ...
            function t() {
                if (!ua) {
                    ...
                    document.getElementById("startMenuWrapper").style.top = "-800px";
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("We are number 1", h + 200, m - 42 - 2, 15, l.guiwhite, "right");
        ...
        codeTable: [
          ...
          [
            ...
            [
              { id: "f", to: "FFA" },
              { id: "r", to: "Soccer" },
              { id: "c", to: "2 Team", to:  "circuit" },
              { id: "s", to: "2 Team", to:  "Siege" },
              { id: "2", to: "2 Team", end: "2TDM" },
              { id: "3", to: "3 Team", end: "3TDM" },
              { id: "4", to: "4 Team", end: "4TDM" },
              { id: "z", to: "4 Team", to:  "Constitution" }
            ],
            [
              { id: "d", to: "Domination" },
        ...
        servers: [
          {
            visible: 0,
            id: "ad",
            // a = okay it's nothing you don't need to know
            // d = 4TDM (b = 2TDM, c = 3TDM)
            type: "ad",
            code: "glitch-worldwide-4",
            at: p.glitch('assorted-buttoned-prose'),
            prefer: !0,
          },{
            visible: 0,
            id: "ad",
